...
enum RepeatSchedule: Hashable {
    ...
    var shortLabel: String {
        ...
        case .weekdays:               return "WKDAYS"
        case .selectedWeekdays:       return "CUSTOM"
        case .weekly(let weekday, _):
            let labels = ["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"]
            guard weekday >= 1 && weekday <= 7 else { return "WEEKLY" }
    ...
    var detailedLabel: String {
        ...
        let dayAbbr  = ["Su","Mo","Tu","We","Th","Fr","Sa"]
